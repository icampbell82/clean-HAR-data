...
Refer to the readme and features_info files in the downloaded file for details of the data processing performed by the UCI group. (For your convenience these have been copied below, verbatim). This script extracts data directly from these values so the description of their methods applies. These are the 66 variables (of the 561 collected in the experiment) that run_analysis.r collects. 
